...
const (
	...
	// for maple weight
	TypeAW      uint16 = 49152
	TypeCNAMEW  uint16 = 49153
	TypeAAAAW   uint16 = 49154
	TypeXW      uint16 = 49155
	TypeLNAME   uint16 = 49156
	TypeTRANS   uint16 = 49157
	TypeAA      uint16 = 49158
	TypeAAPF    uint16 = 49159
	TypeTRANSAA uint16 = 49160
...
func (rr *CNAMEW) String() string {
	return rr.Hdr.String() + strconv.Itoa(int(rr.W)) + " " + sprintName(rr.Target)
}
...
func (rr *XW) String() string {
	if rr.Flag == 0 {
		return fmt.Sprintf("%s %d %s", rr.Hdr.String(), rr.W, rr.A.String())
	}

	return fmt.Sprintf("%s %d %s", rr.Hdr.String(), rr.W, sprintName(rr.Target))
}
...
func (rr *TRANS) String() string {
	...
	return fmt.Sprintf("%s %d %s", rr.Hdr.String(), rr.W, rr.AAAA.String())
}
...
// maple private record
type AA struct {
	Hdr RR_Header
	A   net.IP `dns:"a"`
}

func (rr *AA) String() string {
	if rr.A == nil {
		return rr.Hdr.String()
	}
	return rr.Hdr.String() + rr.A.String()
...
func (rr *AW) String() string {
	if rr.A == nil {
		return rr.Hdr.String()
	}
	return rr.Hdr.String() + strconv.Itoa(int(rr.W)) + " " + rr.A.String()
}
...
func (rr *AAAAW) String() string {
	if rr.AAAA == nil {
		return rr.Hdr.String()
	}
	return rr.Hdr.String() + strconv.Itoa(int(rr.W)) + " " + rr.AAAA.String()
}
